...
class Book
{
    ...
    Book()
    {
      book_name="The Great Expenditure";
      isbn=1500;
      author="Charles Dickens";
      publisher="Vishwashanti books";
    }
...
public class Main
{
    public static void main(String [] args)throws IOException
    {
        ...
        {
            book[i]=new Book();
            book[i].setbook_name("The Great Expenditure");
            book[i].setisbn(1500);
            book[i].setauthor("Charles Dickens");
            book[i].setpublisher("Vishwashanti books");
        }
        }
        catch(Exception ex)
        {
